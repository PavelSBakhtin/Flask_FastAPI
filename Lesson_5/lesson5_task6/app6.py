...
from lesson5_task6.models6 import Users, UsersBase, Base, engine, db6

logging.basicConfig(level=logging.INFO)
logger = logging.getLogger(__name__)
Base.metadata.create_all(bind=engine)
app6 = FastAPI()
templates = Jinja2Templates(directory="lesson5_task6/templates/")
app6.mount("/static", StaticFiles(directory="lesson5_task6/static"), name="static")
...
async def root_redirect():
    logger.info('Отработал GET запрос.')
    return RedirectResponse("/lesson5_task6/users/")
